...
def get_setting(setting, secrets=secrets):
    ...
    try:
        ...
        error_msg = "{} setting is not set".format(setting)
...
INSTALLED_APPS = DEFAULT_APPS + LOCAL_APPS + THIRD_PARTY_APPS + ALLAUTH_APPS
...
DATABASES = {
    'default': {
        ...
        'HOST': get_setting('DATABASE_PASSWORD'),
        'PORT': '',
    }
}
...
MEDIA_ROOT = 'public/static/core/'
MEDIA_URL = '/../../static/core/'
STATIC_URL = '/static/'
